...
## TODO
- For non-solid world brushes we must get a collision point from somewhere else, which might be a trigger or something else non-solid. `R_LightVec` should do the job perfectly.
